...
module "rds" {
  ...
  serverless_min_capacity       = each.value.serverless_min_capacity
  serverless_max_capacity       = each.value.serverless_max_capacity
  ...
  cluster_parmeter_group_name   = each.value.cluster_parmeter_group_name
  cluster_parmeter_group_family = each.value.cluster_parmeter_group_family
